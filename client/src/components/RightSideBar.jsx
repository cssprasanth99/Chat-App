...
const RightSideBar = () => {
  ...
  return (
    selectedUser && (
      <div
        className={`bg-[#8185B2]/10 w-full relative rounded-r-xl text-white ${
          selectedUser ? "max-md:hidden" : ""
        }`}
      >
        <div className="pt-16 flex flex-col items-center gap-2 text-center text-xs font-light mx-auto">
          <img
        ...
        <div className="px-5 text-xs">
          ...
          <div className="mt-2 max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80 pr-1">
